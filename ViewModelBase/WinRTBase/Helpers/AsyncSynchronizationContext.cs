...
namespace WinRTBase
{
    public class AsyncSynchronizationContext : SynchronizationContext
    {
        ...
        {
            var syncContext = Current; if (syncContext == null)
        ...
        public AsyncSynchronizationContext(SynchronizationContext syncContext) { _syncContext = syncContext; }
